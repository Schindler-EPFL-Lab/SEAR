...
3. For MatchAnything run:
    ...
    ```bash
    python3 sear/scripts/eval/relative_camera_pose_estimation/match_relative_camera_pose.py \
...
4. For MatchAnything run:
    ...
    ```bash
    python3 sear/scripts/eval/relative_camera_pose_estimation/minima_relative_camera_pose.py \
        --scenes_root_path /path/to/uncompressed/METU_VisTIR/ \
        --store_results_folder /where/to/store/relative/poses/ \
...
```bash
python3 ./sear/scripts/eval/relative_camera_pose_estimation/vggt_relative_camera_pose.py \
...
```bash
python3 ./sear/scripts/eval/relative_camera_pose_estimation/sear_relative_camera_pose.py \
    --scenes_root_path /path/to/root/with/train/and/eval/scenes \
    --store_results_folder /path/to/store/poses/and/depths \
