...
from sear.scripts.eval_using_predictions import EvalParameters, main


@dataclass
class EvalParametersMultiple(EvalParameters):
    """A config to evaluate outputs of a method using the stored results"""

    method_predictions_root: Path = Path("root")
    """Directory containing outputs"""

    subset: list[str] | None = None
    """Subset of folder to account for in directory"""
